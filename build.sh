...
git clone --single-branch --branch linker-ters --recurse-submodules --shallow-submodules https://github.com/LucasSte/rust.git
...
if [[ "${HOST_TRIPLE}" == "x86_64-pc-windows-msvc" ]] ; then
    ...
    export RUSTFLAGS="-Zshare-generics=off"
fi
./build.sh
popd
